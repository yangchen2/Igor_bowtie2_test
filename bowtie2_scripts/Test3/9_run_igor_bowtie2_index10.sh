...
# DATE: 6/30/25
# DESCRIPTION: Igor's Bowtie2 genome-independent read mapping with S. aureus monoculture data against WoLr2 10-partition index

#SBATCH --job-name=bowtie2_igor_index10
#SBATCH --output=/home/yac027/Igor_bowtie2_test/slurm_out/bowtie2_igor_index10_%A_%a.out
#SBATCH --error=/home/yac027/Igor_bowtie2_test/slurm_out/bowtie2_igor_index10_%A_%a.err
#SBATCH --array=0-15
#SBATCH --ntasks=1
...
OUTPUT_DIR="/home/yac027/Igor_bowtie2_test/output_sam_index10_igor"
